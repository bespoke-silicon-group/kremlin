...
KREMLIN_SOURCES = debug.c kremlin.c ATable.c MemMapAllocator.c CRegion.c arg.c MShadowBase.c MShadowSkadu.c MShadowSTV.c CBuffer.c config.c minilzo.c mpool.c MShadowStat.c MShadowDummy.c
